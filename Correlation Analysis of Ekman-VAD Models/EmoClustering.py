...
ax.set_ylim(1, 5)
ax.set_zlim(1, 5)
scatter = ax.scatter(data_neutral['D'], data_neutral['V'], data_neutral['A'], c=data_neutral['HC_cluster'])
...
ax.set_ylim(1, 5)
ax.set_zlim(1, 5)
scatter = ax.scatter(data_sadness['D'], data_sadness['V'], data_sadness['A'], c=data_sadness['HC_cluster'])
...
ax.set_ylim(1, 5)
ax.set_zlim(1, 5)
scatter = ax.scatter(data_anger['D'], data_anger['V'], data_anger['A'], c=data_anger['HC_cluster'])
...
ax.set_ylim(1, 5)
ax.set_zlim(1, 5)
scatter = ax.scatter(data_fear['D'], data_fear['V'], data_fear['A'], c=data_fear['HC_cluster'])
...
ax.set_ylim(1, 5)
ax.set_zlim(1, 5)
scatter = ax.scatter(data_disgust['D'], data_disgust['V'], data_disgust['A'], c=data_disgust['HC_cluster'])
