...
X_train = X_train.drop(['D'], axis=1).drop(['text'], axis=1).drop(['word_count'], axis=1).drop(['syllable_count'], axis=1).drop(['letter_count'], axis=1).drop(['unique_words'], axis=1).drop(['mean_word_length'], axis=1).drop(['std_dev_word_length'], axis=1).drop(['flesch_reading_ease'], axis=1).drop(['flesch_kincaid_grade'], axis=1).drop(['gunning_fog'], axis=1).drop(['automated_readability_index'], axis=1).drop(['coleman_liau_index'], axis=1).drop(['linsear_write_formula'], axis=1).drop(['dale_chall_readability_score'], axis=1).drop(['mcalpine_eflaw'], axis=1).drop(['reading_time'], axis=1)
...
X_test = X_test.drop(['D'], axis=1).drop(['text'], axis=1).drop(['word_count'], axis=1).drop(['syllable_count'], axis=1).drop(['letter_count'], axis=1).drop(['unique_words'], axis=1).drop(['mean_word_length'], axis=1).drop(['std_dev_word_length'], axis=1).drop(['flesch_reading_ease'], axis=1).drop(['flesch_kincaid_grade'], axis=1).drop(['gunning_fog'], axis=1).drop(['automated_readability_index'], axis=1).drop(['coleman_liau_index'], axis=1).drop(['linsear_write_formula'], axis=1).drop(['dale_chall_readability_score'], axis=1).drop(['mcalpine_eflaw'], axis=1).drop(['reading_time'], axis=1)
...
LINEAR REGRESSOR
Mean Absolute Error (MAE): 0.14787419658661774
Mean Squared Error (MSE): 0.037959569269478265
Root Mean Squared Error (RMSE): 0.19483215666177456 
R^2: 0.13885444625460375
...
RANDOM FOREST REGRESSOR
Mean Absolute Error (MAE): 0.14705395597046708
Mean Squared Error (MSE): 0.03867627620247228
Root Mean Squared Error (RMSE): 0.1966628490652779 
R^2: 0.1225953316080487

GRADIENT BOOSTING REGRESSOR
Mean Absolute Error (MAE): 0.14621431119732087
Mean Squared Error (MSE): 0.038063910933796026
Root Mean Squared Error (RMSE): 0.19509974611412498 
R^2: 0.13648736564681918
