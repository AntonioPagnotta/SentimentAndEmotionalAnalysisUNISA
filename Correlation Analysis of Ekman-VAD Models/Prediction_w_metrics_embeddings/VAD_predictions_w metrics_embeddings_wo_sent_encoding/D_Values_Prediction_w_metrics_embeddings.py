...
X_train = primary_dataset.drop(['D'], axis=1).drop(['text'], axis=1)
X_train = X_train.drop(['predicted_emotion'], axis=1)
Y_train = primary_dataset['D']

X_test = secondary_dataset.drop(['D'], axis=1).drop(['text'], axis=1)
...
LINEAR REGRESSOR
Mean Absolute Error (MAE): 0.14011883794582705
Mean Squared Error (MSE): 0.03367194522812788
Root Mean Squared Error (RMSE): 0.18349916955705245 
R^2: 0.2361228939845823
...
RANDOM FOREST REGRESSOR
Mean Absolute Error (MAE): 0.13408415259847736
Mean Squared Error (MSE): 0.032169731771505033
Root Mean Squared Error (RMSE): 0.1793592254987321 
R^2: 0.2702019013032302

GRADIENT BOOSTING REGRESSOR
Mean Absolute Error (MAE): 0.13406889223732127
Mean Squared Error (MSE): 0.032252780567409385
Root Mean Squared Error (RMSE): 0.17959059153365853 
R^2: 0.2683178677719422
'''